         ...
         %>
            <div class="row">
               <div class="col-lg-8 offset-lg-2">
                  <div class="full">
                     <form name="signupform" method="post" action="contactcontroller">
                        <fieldset>
                        	<table>
                           	<tr>UserType :
                           		<td>user<input type="radio" value="user" name="usertype"></td>
                           		<td>seller<input type="radio" value="seller" name="usertype"></td>
                           	</tr>
                           </table>
