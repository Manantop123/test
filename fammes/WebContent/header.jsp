               ...
               <nav class="navbar navbar-expand-lg custom_nav-container ">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav">
                       ...
                       <li class="nav-item dropdown">
 						...
 						<li class="nav-item dropdown">
                           ...
                           <ul class="dropdown-menu">
                              ...
                              <b>category:</b>
                              <li><a href="filter_product.jsp?product_category=mens">--Mens</a></li>
                              <li><a href="filter_product.jsp?product_category=womens">--Womens</a></li>
                              <li><a href="filter_product.jsp?product_category=kids">--Kids</a></li>
                           </ul>
                        </li>
	                   ...
	                   <li class="nav-item">
                           <a class="nav-link" href="changenewpsw.jsp">Change password</a>
                        </li>
						<li class="nav-item">
