                  ...
                  <div class="full">
                     <form name="addproduct" method="post" action="productcontroller" enctype="multipart/form-data">
                        ...
                        <fieldset>
                           ...
                           <input type="text" placeholder="Enter product model" name="model" required />
                           
                           
                           <input type="text" placeholder="Enter product price" name="price" required />
                                                      <table>
                           	<tr>upload image :
                           		<td><input type="file" value="fileName" name="product_image"></td>
                           	</tr>
                           </table>
							

							<textarea placeholder="enter product details" name="desc" required></textarea>
